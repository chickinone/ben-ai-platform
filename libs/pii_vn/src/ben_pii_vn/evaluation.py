"""Bộ đánh giá PII deterministic, dùng được bởi test lẫn CLI."""
...
from ben_pii_vn.core import Redactor, detect_pii
...
def evaluate() -> dict:
    ...
    metrics = {}
    for kind in sorted(set(totals) | set(false_positive)):
